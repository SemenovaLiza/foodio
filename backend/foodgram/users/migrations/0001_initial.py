# Generated by Django 3.2 on 2025-05-31 19:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=200, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+\\Z', message='Никнейм должен содержать: буквы латинского алфавита,цифры, подчеркивание, знак "@"')], verbose_name='Никнейм пользователя')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('email', 'password'), name='unique_password_email'),
        ),
    ]
